...
exports.create = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var existingUser, newUser, savedUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          return _context.abrupt("return", res.redirect("/newuser"));
        case 5:
          _context.prev = 5;
          _context.next = 8;
        ...
        case 20:
          ...
          res.status(500).send({
            message: _context.t0.message || "Some error occurred while creating a user"
          });
        case 23:
        case "end":
...
exports.find = function (req, res) {
  if (req.query.id) {
    ...
    Register.findById(id).then(function (data) {
      ...
      res.status(500).send({
        message: "Erroor retriving with id" + id
      });
    });
  } else {
    Register.find().then(function (user) {
      res.send(user);
    })["catch"](function (err) {
      res.status(500).send({
...
exports.finds = function (req, res) {
  if (req.query.id) {
    var id = req.query.id;
    Student.findById(id).then(function (data) {
      if (!data) {
        res.status(404).send({
          message: "Not found user with id" + id
        });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return Register.findByIdAndUpdate(req.params.id, {
            firstname: req.body.firstname,
            lastname: req.body.lastname,
            email: req.body.email,
            password: req.body.password,
...
exports.confirmDelete = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          req.flash("deleteMessage", "Successfully deleted ".concat(req.body.firstname, " ").concat(req.body.lastname));
          _context4.next = 9;
          break;
        case 7:
...
exports.search = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var locals, searchTerm, searchNoSpecialChar, student;
